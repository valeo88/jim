...
@NoArgsConstructor
@AllArgsConstructor
public class SellBondDto extends OperationDto {
    ...
    @Builder
    public SellBondDto(String portfolioName, LocalDateTime whenAdd, @NotBlank String symbol, String name,
    ...
    public static SellBondDto from(Operation operation) {
        var dto = new SellBondDto();
